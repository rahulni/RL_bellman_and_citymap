...
SPEED = 5.0          # FIX ME! Forward speed (pixels/step) - Way too fast!
TURN_SPEED = 5.0    # FIX ME! Regular turn angle (degrees/step) - Too slow!
...
GAMMA = 0.95        # FIX ME! Discount factor for future rewards (0 to 1)
...
EPSILON_START = 1.0        # FIX ME! Initial exploration rate - starts too low!
EPSILON_MIN = 0.001       # INCREASED: Keep exploring even late
EPSILON_DECAY = 0.9999    # MUCH SLOWER: Don't decay too fast
...
class CarBrain:
    def __init__(self, map_image: QImage):
        ...
        self.steps = 0
        self.epsilon = EPSILON_START  # FIX ME! Exploration rate - starts too low! 
